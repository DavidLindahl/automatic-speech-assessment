...
def test_apply_packet_loss():
    ...
    mixed, start_time, end_time = apply_packet_loss(
        waveform, sr, min_duration=0.5, max_duration=0.5
    )
...
def test_apply_clipping():
    ...
    threshold = 0.1
    mixed, start_time, end_time = apply_clipping(
        waveform, sr, min_duration=0.5, max_duration=0.5, threshold=threshold
    )
