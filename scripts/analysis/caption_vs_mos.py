...
Usage:
    python scripts/analysis/caption_vs_mos.py \
        --results-path results/evaluation/global/sft/sft_full_paper_h100_eval_greedy/test_FOR_results.json \
        --results-path results/evaluation/global/sft/sft_full_paper_h100_eval_greedy/test_LIVE_results.json
"""
