...
### Submit with: bsub < jobs/temporal/eval/evaluate_sft_temporal_max_mos3_h100_temp0.sh
### ============================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-results/evaluation/temporal/sft/sft-temporal-maxmos3__step305__greedy}"
...
if [ ! -f "$DATASET_PATH" ]; then
  ...
  echo "Run first: bsub < jobs/temporal/data/build_temporal_training_json.sh"
  exit 1
fi
