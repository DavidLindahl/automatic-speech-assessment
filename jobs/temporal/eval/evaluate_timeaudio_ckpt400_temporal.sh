...
### Submit with: bsub < jobs/temporal/eval/evaluate_timeaudio_ckpt400_temporal.sh
### ============================================================
...
OUTPUT_DIR="results/evaluation/temporal/sft/timeaudio-reimpl__ckpt400__greedy_FOR"
