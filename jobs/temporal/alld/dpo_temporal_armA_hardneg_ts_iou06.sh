...
### Submit with: bsub < jobs/temporal/alld/dpo_temporal_armA_hardneg_ts_iou06.sh
###
...
#BSUB -q gpuh100
#BSUB -J dpo-temporal-armA-hardneg-ts-iou06
#BSUB -n 4
...
#BSUB -M 64GB
#BSUB -W 24:00
#BSUB -o /work3/s234817/automatic-speech-assessment/logs/dpo_temporal_armA_hardneg_ts_iou06_%J.out
#BSUB -e /work3/s234817/automatic-speech-assessment/logs/dpo_temporal_armA_hardneg_ts_iou06_%J.err
...
HUB_REPO="Leng2beat/dpo-temporal-armA-hardneg-ts-iou06"
...
torchrun --nproc_per_node=1 scripts/train/dpo-finetune.py \
    --model-name "dpo_temporal_armA_hardneg_ts_iou06" \
    ...
    --no-hub-private \
    --final-save-only \
    --wandb-run-name "dpo-temporal-armA-hardneg-ts-iou06"
