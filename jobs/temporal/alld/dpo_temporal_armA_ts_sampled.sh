...
### Submit with: bsub < jobs/temporal/alld/dpo_temporal_armA_ts_sampled.sh
###
...
### own sampled (wrong) interval (train_dpo_armA_cycle_timestamp_sampled.json,
...
#BSUB -q gpuh100
#BSUB -J dpo-temporal-armA-ts-sampled
#BSUB -n 4
...
#BSUB -M 64GB
#BSUB -W 24:00
#BSUB -o /work3/s234817/automatic-speech-assessment/logs/dpo_temporal_armA_ts_sampled_%J.out
#BSUB -e /work3/s234817/automatic-speech-assessment/logs/dpo_temporal_armA_ts_sampled_%J.err

source /work3/s234817/automatic-speech-assessment/jobs/_lib/preamble.sh
echo "Branch   : $(git branch --show-current 2>/dev/null || echo unknown)"
echo "Commit   : $(git rev-parse --short HEAD 2>/dev/null || echo unknown)"

TRAIN_JSON="$EXPERIMENT_DIR/data/processed/dpo/train_dpo_armA_cycle_timestamp_sampled.json"
...
HUB_REPO="Leng2beat/dpo-temporal-armA-ts-sampled"
...
torchrun --nproc_per_node=1 scripts/train/dpo-finetune.py \
    --model-name "dpo_temporal_armA_ts_sampled" \
    ...
    --no-hub-private \
    --final-save-only \
    --wandb-run-name "dpo-temporal-armA-ts-sampled"

echo "=========================================="
echo "DPO temporal ARM A TS-SAMPLED (LR 1e-6) training complete: $(date)"
echo "Hub: $HUB_REPO"
echo "=========================================="
