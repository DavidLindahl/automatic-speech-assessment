...
#BSUB -M 48GB
#BSUB -W 24:00
#BSUB -o logs/sft_gc_sweep5105_%J.out
#BSUB -e logs/sft_gc_sweep5105_%J.err
...
torchrun --nproc_per_node=1 scripts/train/supervised-finetune.py \
    ...
    --json-path data/processed/temporal/train_gc_timelast_sweep_5105.json \
    --data-root data \
    --model-name "$EXPERIMENT_DIR/models/sft_gc_timelast_sweep5105" \
    --bf16 \
    ...
    --install-time-tokens \
    --wandb-run-name "sft-gc-timelast-sweep5105"
