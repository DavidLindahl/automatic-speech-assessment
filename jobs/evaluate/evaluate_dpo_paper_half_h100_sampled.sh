...
uv run python src/asa/evaluate.py eval-mos \
    --model-path "$EXPERIMENT_DIR/models/dpo_paper_half_h100" \
    --output-dir "$EXPERIMENT_DIR/results/evaluation/dpo_paper_half_h100_eval_sampled" \
...
uv run python scripts/dpo_sanity_check.py \
    "$EXPERIMENT_DIR/results/evaluation/dpo_paper_half_h100_eval_sampled"

echo "=========================================="
echo "Sampled DPO evaluation complete: $(date)"
echo "=========================================="
