...
### ============================================================
#BSUB -q gpua40
#BSUB -J eval-sft-warmup-plus3epoch-h100-ds-torchrun-retry-plus4-a40
#BSUB -n 4
...
OUTPUT_PATH="results/evaluation/sft/sft_warmup_plus3epoch_h100_ds_torchrun_retry_plus4_eval_a40"
DATASETS=(
