...
uv run python src/asa/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/dpo_paper_half_h100_eval_greedy" \
...
uv run python scripts/dpo_sanity_check.py \
    "$EXPERIMENT_DIR/results/evaluation/dpo_paper_half_h100_eval_greedy"

echo "=========================================="
echo "Greedy DPO evaluation complete: $(date)"
echo "=========================================="
