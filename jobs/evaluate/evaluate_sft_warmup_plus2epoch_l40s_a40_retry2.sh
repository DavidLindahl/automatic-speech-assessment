...
### ============================================================
#BSUB -q gpua40
#BSUB -J eval-sft-warmup-plus2epoch-l40s-a40-retry2
#BSUB -n 4
...
MODEL_PATH="models/sft_warmup_plus2epoch_l40s"
OUTPUT_PATH="results/evaluation/sft_warmup_plus2epoch_l40s_eval_a40"
DATASETS=(
