...
### Submit with: bsub < jobs/evaluate/evaluate_dpo_paper_half_h100_lr1e6_delimiterfix.sh
###
### Evaluates models/dpo_paper_half_h100_lr1e6_delimiterfix (full DPO run, job
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o /work3/s234817/automatic-speech-assessment/logs/eval_dpo_lr1e6_%J.out
#BSUB -e /work3/s234817/automatic-speech-assessment/logs/eval_dpo_lr1e6_%J.err
