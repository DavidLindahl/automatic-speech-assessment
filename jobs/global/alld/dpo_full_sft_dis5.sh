...
### Submit with: bsub < jobs/global/alld/dpo_full_sft_dis5.sh
###
...
###   - The ONLY differences: data is train_dpo_full_sft_dis.json (the 4-dim
###     file with `dis` joined onto every record, identical pairs, built by
###     scripts/data/join_dis_into_dpo.py), and --use-discontinuity, which makes
...
#BSUB -M 64GB
#BSUB -W 24:00
#BSUB -o /work3/s234817/automatic-speech-assessment/logs/dpo_full_sft_dis5_%J.out
#BSUB -e /work3/s234817/automatic-speech-assessment/logs/dpo_full_sft_dis5_%J.err

source /work3/s234817/automatic-speech-assessment/jobs/_lib/preamble.sh
echo "Branch   : $(git branch --show-current 2>/dev/null || echo unknown)"
echo "Commit   : $(git rev-parse --short HEAD 2>/dev/null || echo unknown)"

TRAIN_JSON="$EXPERIMENT_DIR/data/processed/dpo/train_dpo_full_sft_dis.json"
POLICY_BASE="$EXPERIMENT_DIR/models/sft_full_paper_h100"
HUB_REPO="Leng2beat/dpo-full-sft-dis5"
...
torchrun --nproc_per_node=1 scripts/train/dpo-finetune.py \
    ...
    --no-hub-private \
    --final-save-only \
    --wandb-run-name "dpo-full-sft-dis5"
