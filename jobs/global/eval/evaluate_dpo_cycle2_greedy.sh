...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_dpo_cycle2_greedy_%J.out
#BSUB -e logs/eval_dpo_cycle2_greedy_%J.err
...
uv run python scripts/eval/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/dpo/dpo_cycle2_eval_greedy" \
...
echo "=========================================="
echo "DPO cycle-2 greedy evaluation complete: $(date)"
echo "=========================================="
