...
### Submit with: bsub < jobs/global/eval/evaluate_sft_warmup_regularized_a40.sh
### ============================================================
...
### -- Job name --
#BSUB -J eval-sft-warmup-reg-a40
...
MODEL_PATH="models/sft_warmup_regularized"
OUTPUT_PATH="results/evaluation/sft/sft_warmup_regularized_eval_a40"
