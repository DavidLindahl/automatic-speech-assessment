#!/bin/bash
### ============================================================
### DTU HPC — Evaluate paper-style half-data SFT warmup (GREEDY)
### Submit with: bsub < jobs/global/eval/evaluate_sft_warmup_paper_half_h100_greedy.sh
### ============================================================

#BSUB -q gpuh100
#BSUB -J eval-sft-warmup-paper-half-h100-greedy
#BSUB -n 4
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_sft_warmup_paper_half_h100_greedy_%J.out
#BSUB -e logs/eval_sft_warmup_paper_half_h100_greedy_%J.err
...
uv run python scripts/eval/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/sft/sft_warmup_paper_half_h100_eval_greedy" \
...
echo "=========================================="
echo "Warmup greedy evaluation complete: $(date)"
echo "=========================================="
