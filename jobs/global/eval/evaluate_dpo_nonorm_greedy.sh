...
### Submit with: bsub < jobs/global/eval/evaluate_dpo_cycle2_greedy.sh
### ============================================================

#BSUB -q gpuh100
#BSUB -J eval-dpo-nonorm-greedy
#BSUB -n 4
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_dpo_nonorm_greedy_%J.out
#BSUB -e logs/eval_dpo_nonorm_greedy_%J.err
...
uv run python scripts/eval/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/dpo/dpo_nonorm_eval_greedy" \
...
echo "=========================================="
echo "DPO nonorm greedy evaluation complete: $(date)"
echo "=========================================="
