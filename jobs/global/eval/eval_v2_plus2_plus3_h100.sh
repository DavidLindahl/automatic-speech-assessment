...
### Submit with: bsub < jobs/global/eval/eval_v2_plus2_plus3.sh
### ============================================================

#BSUB -q gpuh100
#BSUB -J eval-v2-plus2-plus3-h100
#BSUB -n 4
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_v2_plus2_plus3_h100_%J.out
#BSUB -e logs/eval_v2_plus2_plus3_h100_%J.err
