...
#BSUB -q gpuh100
#BSUB -J eval-sft-clean9500-sampled
#BSUB -n 4
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_sft_clean9500_sampled_%J.out
#BSUB -e logs/eval_sft_clean9500_sampled_%J.err
...
uv run python scripts/eval/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/sft/sft_clean9500_eval_sampled" \
...
echo "=========================================="
echo "SFT clean9500 sampled evaluation complete: $(date)"
echo "=========================================="
