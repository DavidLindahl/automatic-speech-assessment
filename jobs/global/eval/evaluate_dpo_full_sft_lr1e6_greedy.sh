#!/bin/bash
### ============================================================
### DTU HPC — Evaluate DPO-on-Full-SFT (GREEDY)
### Mirrors evaluate_sft_full_paper_h100_greedy.sh.
### Submit with: bsub < jobs/global/eval/evaluate_dpo_full_sft_lr1e6_greedy.sh
### ============================================================

#BSUB -q gpuh100
#BSUB -J eval-dpo-full-sft-lr1e6-greedy
#BSUB -n 4
...
#BSUB -M 32GB
#BSUB -W 4:00
#BSUB -o logs/eval_dpo_full_sft_lr1e6_greedy_%J.out
#BSUB -e logs/eval_dpo_full_sft_lr1e6_greedy_%J.err
...
uv run python scripts/eval/evaluate.py eval-mos \
    ...
    --output-dir "$EXPERIMENT_DIR/results/evaluation/dpo/dpo_full_sft_lr1e6_eval_greedy" \
...
echo "=========================================="
echo "DPO-full-SFT greedy evaluation complete: $(date)"
echo "=========================================="
