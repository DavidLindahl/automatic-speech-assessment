...
def main():
    if not AUDIO_PATH.exists():
        raise FileNotFoundError(
            ...
            f"Put a wav named 'demo.wav' in the repo root (same folder as notebooks/)."
        )
    ...
    # Audio Flamingo 3 HF uses apply_chat_template differently than Qwen2-Audio
    # Based on research, it supports 'audio' in the content list
    ...
    # Debug: show the rendered prompt structure (if possible)
    print("\n--- Inputs Prepared ---")
    ...
    print("\n" + "=" * 80)
    print("Audio Flamingo 3 assessment")
    print("=" * 80)
    print(response)
    print("\n" + "=" * 80)
