...
def train(
    ...
    warmup_ratio: float = typer.Option(0.0, help="Fraction of total steps used for LR warmup."),
    lr_scheduler_type: str = typer.Option("linear", help="LR scheduler (linear|cosine|constant|...)."),
